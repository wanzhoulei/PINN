...
tracepath = "./results/2dpoisson_Hinv_{}iter_seed{}_alpha{}_f_{}_N40_{}.csv".format(n_iter, 
...
figpath = './results/2dpoisson_Hinv_{}iter_seed{}_alpha{}_f_{}_N40_{}_solution.png'.format(n_iter, 
    random_seed, str(alpha).replace('.','d'), str(func_RHS).split(' ')[1], layertostr(layers))
...
pltpath = "./results/2dpoisson_Hinv_{}iter_seed{}_alpha{}_f_{}_N40_{}_loss.png".format(n_iter, 
    random_seed, str(alpha).replace('.','d'), str(func_RHS).split(' ')[1], layertostr(layers))
