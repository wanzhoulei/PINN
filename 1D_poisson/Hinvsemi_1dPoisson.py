'''
This file performs the H^-1 semi norm GD Algorithm on the 1d Poisson Equation with PINN
...
##construct the H1 kernel without damping
L = NegLaplacian(N_f)
kernel = HinvsemiKernel(PINN, N_f, X_f_train, L, alpha=alpha)
...
tracepath = "./results/Hinvsemi_{}iter_seed{}_alpha{}.csv".format(n_iter, random_seed, alpha)
np.savetxt(tracepath, np.array(PINN.loss_trace), delimiter=",")

##save the plot
figpath = './results/Hinvsemi_{}iter_seed{}_alpha{}_plot.png'.format(n_iter, random_seed, alpha)
