...
L = NegLaplacian(N_f)
kernel = H1Kernel(PINN, N_f, X_f_train, L, alpha=alpha)
...
tracepath = "./results/H1_{}iter_seed{}_alpha{}.csv".format(n_iter, random_seed, alpha)
np.savetxt(tracepath, np.array(PINN.loss_trace), delimiter=",")

##save the plot
figpath = './results/H1_{}iter_seed{}_alpha{}_plot.png'.format(n_iter, random_seed, alpha)
