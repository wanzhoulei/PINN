...
tracepath = "./results/2dpoisson_Hinvsemi_{}iter_seed{}_alpha{}_f_{}_N{}_{}_gamma{}.csv".format(n_iter, 
...
#save the cpu time
tracepath2 = "./results/2dpoisson_Hinvsemi_{}iter_seed{}_alpha{}_f_{}_N{}_{}_gamma{}_CPUtime.csv".format(n_iter, 
    random_seed, str(alpha).replace('.','d'), str(func_RHS).split(' ')[1], N, layertostr(layers), gamma)
...
figpath = './results/2dpoisson_Hinvsemi_{}iter_seed{}_alpha{}_f_{}_N{}_{}_solution_gamma{}.png'.format(n_iter, 
    random_seed, str(alpha).replace('.','d'), str(func_RHS).split(' ')[1], N, layertostr(layers), gamma)
...
pltpath = "./results/2dpoisson_Hinvsemi_{}iter_seed{}_alpha{}_f_{}_N{}_{}_loss_gamma{}.png".format(n_iter, 
    random_seed, str(alpha).replace('.','d'), str(func_RHS).split(' ')[1], N, layertostr(layers), gamma)
