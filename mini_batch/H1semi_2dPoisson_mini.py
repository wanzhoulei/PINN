...
n_iter = 10; gamma=1.99; BC_ratio = 1; Interior_ratio=.5; lr=32; alpha=0.01
write_pickle = True
...
##do H1 seminorm NGD
H1semi_optimizer(PINN, lr, n_iter, L, BC_ratio=BC_ratio, Interior_ratio=Interior_ratio, alpha=alpha)
...
tracepath = "./results/2dpoisson_H1semimini_lr{}_{}iter_seed{}_f_{}_N{}_{}_gamma{}_BCRatio{}_IntRatio{}_alpha{}.csv".format(lr, len(PINN.loss_trace), 
...
#save the cpu time
tracepath2 = "./results/2dpoisson_H1semimini_lr{}_{}iter_seed{}_f_{}_N{}_{}_gamma{}_BCRatio{}_IntRatio{}__alpha{}_CPUtime.csv".format(lr, len(PINN.loss_trace), 
    random_seed, str(func_RHS).split(' ')[1], N, layertostr(layers), gamma, BC_ratio, Interior_ratio, alpha)
...
figpath = './results/2dpoisson_H1semimini_lr{}_{}iter_seed{}_f_{}_N{}_{}_solution_gamma{}_BCRatio{}_IntRatio{}_alpha{}.png'.format(lr, len(PINN.loss_trace), 
    random_seed, str(func_RHS).split(' ')[1], N, layertostr(layers), gamma, BC_ratio, Interior_ratio, alpha)
...
plt.title("Mini batch H1 seminorm NGD on 2d Poisson with PINN loss trace")
##save the convergence trace plot
pltpath = "./results/2dpoisson_H1semimini_lr{}_{}iter_seed{}_f_{}_N{}_{}_loss_gamma{}_BCRatio{}_IntRatio{}_alpha{}.png".format(lr, len(PINN.loss_trace), 
    random_seed, str(func_RHS).split(' ')[1], N, layertostr(layers), gamma, BC_ratio, Interior_ratio, alpha)
plt.savefig(pltpath, dpi=300)

if write_pickle:
    pickle_writepath = './results/2dpoisson_H1semimini_lr{}_{}iter_seed{}_f_{}_N{}_{}_PINN_gamma{}_BCRatio{}_IntRatio{}_alpha{}.dat'.format(lr, len(PINN.loss_trace), 
        random_seed, str(func_RHS).split(' ')[1], N, layertostr(layers), gamma, BC_ratio, Interior_ratio, alpha)
