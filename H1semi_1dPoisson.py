'''
This file performs the H1 semi norm GD Algorithm on the 1d Poisson Equation with PINN
...
L = NegLaplacian(N_f)
kernel = H1semiKernel(PINN, N_f, X_f_train, L, alpha=alpha)
...
tracepath = "./results/H1semi_{}iter_seed{}_alpha{}.csv".format(n_iter, random_seed, alpha)
np.savetxt(tracepath, np.array(PINN.loss_trace), delimiter=",")

##save the plot
figpath = './results/H1semi_{}iter_seed{}_alpha{}_plot.png'.format(n_iter, random_seed, alpha)
